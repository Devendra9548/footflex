    ...
    <div class="container-fluid">
        <div class="row py-3">
            ...
            <div class="col-6 d-flex align-items-center">
                <nav class="navbar">
                    <ul class="">
                        <li><a href="/shop?category=sport-shoes">Sport Shoes</a></li>
                        <li><a href="/shop?category=casual-shoes">Casual Shoes</a></li>
                        <li><a href="/shop?category=formal-footwear">Formal Footwear</a></li>
            ...
            <div class="col-3 d-flex align-items-center">
                <form action="" class="w-100 col-4 d-flex align-items-center position-relative">
                    <input type="text" class="form-control ps-5 py-2"
                        placeholder="Search" name="search" style="background:#f9f9f9;font-weight: 300;">
            ...
            <div class="col-2 d-flex align-items-center justify-content-end" style="padding-right:30px">
                <div class="cards d-flex align-items-center">
                    ...
                    <div class="cart text-center me-4 position-relative">
                        ...
                        <p class="name"><a href="/add-to-cart">
                        @if(session('cart'))
                    ...
                    <div class="login text-center">
                        <p><a href="{{ route('login.dashboard')}}"><i class="fa-solid fa-user"></i></a></p>
